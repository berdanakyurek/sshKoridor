...
while True:
    ...
    p1Size = int(rubyCode.recv(10).decode("utf-8"))
    user1Str = rubyCode.recv(p1Size).decode("utf-8").replace("\n", "\r\n")
    chan1.send(user1Str)
    #print("ara")
    #print("waiting p2 string")
    p2Size = int(rubyCode.recv(10).decode("utf-8"))
    user2Str = rubyCode.recv(p2Size).decode("utf-8").replace("\n", "\r\n")
    chan2.send(user2Str)
    #print("waiting turn")
